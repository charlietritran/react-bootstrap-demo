...
class SolrConnectorDemo extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      solrSearchUrl: "http://localhost/solr/historySearch/select", //       solrSearchUrl: "http://localhost:8983/solr/historySearch/select",
      query: "*:*",
      filter: "",
      fetchFields: "",
    };
    ...
    return (
      <div>
        <form className="inputForm " onSubmit={this.onSubmit.bind(this)}>
          <h3 className="card-title bg-info text-white">searchParams:</h3>
          <p>
            solrSearchUrl:{" "}
            <input
              type="text"
          ...
          <p>
            <button type="submit" className="btn-info a-block ml-auto">
              Search
            </button>
          </p>
        </form>
